...
tf.app.flags.DEFINE_integer('batch_size', 200, 'batch size') # 배치 크기
...
tf.app.flags.DEFINE_integer('layer_size', 6, 'layer size') # 멀티 레이어 크기 (multi rnn)
tf.app.flags.DEFINE_integer('hidden_size', 256, 'weights size') # 가중치 크기
...
tf.app.flags.DEFINE_integer('embedding_size', 256, 'embedding size') # 임베딩 크기
